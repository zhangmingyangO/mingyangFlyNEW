...
public class MailUtil {
    public static void main(String[] args) throws Exception {
        ...
        sendActiveMail("1154540719@qq.com","555555555555");
    }
    // 发件人的 邮箱 和 密码（替换为自己的邮箱和密码）
    // PS: 某些邮箱服务器为了增加邮箱本身密码的安全性，给 SMTP 客户端设置了独立密码（有的邮箱称为“授权码”）,
    //     对于开启了独立密码的邮箱, 这里的邮箱密码必需使用这个独立密码（授权码）。
    public static String myEmailAccount = "13652108928@163.com";
    public static String myEmailPassword = "159753z";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "1154540719@qq.com";
